...
public class FilesExample {
    public static void main(String[] args) throws IOException {
        File file = new File("C:\\Users\\ale05\\HelloWorldProject\\src\\classwork\\c12\\abc.doc");
        // задаёт путь, но оне создаёт
        ...
        try {
            ...
            System.out.println(file.renameTo(new File("abc44.doc")));
        ...
        File file3 = new File("C:\\Users\\ale05\\HelloWorldProject");
        ...
        System.out.println(Arrays.toString(file3.listFiles(new DocFilter()))); // путь и название + фильтр .doc но докав у меня нет :)
